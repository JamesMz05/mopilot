...
function VehicleCard({ v }: { v: Vehicle }) {
  return (
    <div className="bg-white rounded-2xl border-2 border-gray-100 hover:border-cc-300 shadow-sm hover:shadow-md transition-all overflow-hidden group">
      {/* Category badge */}
        ...
        <div className="bg-white rounded-2xl p-4 sm:p-6 mb-8 border border-gray-200 shadow-sm">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                      seatFilter === opt
                        ...
                        : 'bg-gray-100 text-gray-600 hover:bg-cc-100 hover:text-cc-700'
                    }`}
                  >
                    {opt}
                  </button>
          ...
          {(seatFilter !== 'Alle' || rangeFilter !== 'Alle' || featureFilter !== 'Alle') && (
            <button
              ...
              className="mt-3 text-xs text-gray-400 hover:text-cc-600 transition-colors underline"
            >
              Filter zurücksetzen
            </button>
          )}
