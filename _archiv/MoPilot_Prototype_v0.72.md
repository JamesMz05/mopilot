...
MoPilot ist ein KI-gestützter Mobilitätsassistent für E-Carsharing im ländlichen Raum. Der Prototyp v0.72 erweitert v0.71 um den **CC Kundenassistent** (cc-kunden.mopilot.website) für die Car&RideSharing Community eG in Overath und dokumentiert das einheitliche **API-Key- und Secrets-Management** über alle Sub-Projekte hinweg.
...
| CSS-Prefix | `zeo-*` | `cc-*` |
| Tailwind-Palette | Grüntöne (ZEO-Branding) | Grüntöne (CC-Branding) |
...
*Erstellt mit Claude Code |  gekürzt von Reinhard v0.72 – 10. März 2026*
