...
MoPilot ist ein KI-gestützter Mobilitätsassistent für E-Carsharing im ländlichen Raum. Der Prototyp v0.71 erweitert v0.7 um eine **Admin-Benutzerverwaltung** auf mopilot.website, behebt **Synchronisierungsprobleme** zwischen Ideenplattform und Hauptsystem, fügt **Login/Logout-Funktionen** auf mopilot.website hinzu, erweitert die Rollen um **MOPILOT_TEAM** und verbessert die **E-Mail-Zustellbarkeit** durch optimierte Header und DNS-Härtung (DKIM, DMARC).
...
*Erstellt mit Claude Code | v0.71 – 9. März 2026*
*Änderungen gegenüber v0.7: Admin-Benutzerverwaltung (Kap. 10.5), User-Sync-Bugfixes bei Passwort-Reset und Admin-Synchronisierung (Kap. 10.2, 10.7), neue Rolle MOPILOT_TEAM (Kap. 10.6), Login/Logout auf mopilot.website (Kap. 10.4), Navigation auf Hauptmenü (Kap. 10.3), E-Mail-Zustellbarkeit verbessert (Kap. 10.8), DNS-Härtung mit DKIM und DMARC (Kap. 10.9)*
