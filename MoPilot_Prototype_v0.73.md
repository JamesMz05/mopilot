...
**Prototyp v0.73**   Datum: 11. März 2026
...
MoPilot ist ein KI-gestützter Mobilitätsassistent für E-Carsharing im ländlichen Raum. Der Prototyp v0.73 erweitert v0.72 um ein **umfassendes UI/UX-Redesign** aller 4 Plattformen mit einem **Shared Design System** (Petrol/Teal-Primärfarbe, Plus Jakarta Sans + DM Sans Schriften, Glassmorphism-Header, warme Schatten), einem **KI-Chat-Redesign** (Gradient-Avatare, Typing-Animationen, Streaming-UX) sowie **Accessibility- und SEO-Verbesserungen** (SVG-Favicons, Open-Graph-Metadaten, Skip-Navigation).
...
Die CI/CD-Pipeline deckt Hauptsystem und ZEO-Kunden ab. Die Ideenplattform und CC-Kunden werden aktuell manuell deployed (`docker compose up -d --build`). Jeder Push auf `master` deployt automatisch Hauptsystem und ZEO-Kunden.
...
| CI/CD | Automatisch (GitHub Actions + rsync) | Manuell (`docker compose up -d --build`) |
...
*Erstellt mit Claude Code | v0.73 – 11. März 2026*
